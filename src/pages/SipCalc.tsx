...
const SIPCalculator: React.FC = () => {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto bg-white rounded-md shadow-lg">
      ...
      >
        <ToggleButton value="SIP" style={{ backgroundColor: type === "SIP" ? "#8BC34A" : "" }}>
          SIP
        </ToggleButton>
        <ToggleButton value="Lumpsum" style={{ backgroundColor: type === "Lumpsum" ? "#8BC34A" : "" }}>
          Lumpsum
        </ToggleButton>
      </ToggleButtonGroup>
      ...
      <div className="flex flex-col md:flex-row gap-10 items-center">
        ...
        <div className="flex-1 space-y-6">
          ...
          <div>
            ...
            <Slider
              value={timePeriod}
              onChange={(e, val) => setTimePeriod(val as number)}
              step={1}
              min={1}
              max={30}
            />
