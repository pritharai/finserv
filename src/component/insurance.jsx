...
It's like a financial safety net — you might not need it every day, but when life surprises you, you're protected.
      ...
      {/* WhatsApp CTA */}
      <div className="max-w-3xl mx-auto text-center bg-gradient-to-r from-blue-100 to-teal-100 p-8 rounded-lg shadow-md border-l-4 border-green-600">
        <h2 className="text-2xl font-bold text-blue-700 mb-2">Need Help Selecting Insurance?</h2>
        <p className="text-gray-700 mb-4">
          Confused about which policy suits you best? Chat with us and we’ll help you out!
        </p>
        <a
          href="https://wa.me/919463984957?text=Hi%20I%20need%20help%20choosing%20insurance"
          target="_blank"
          rel="noopener noreferrer"
