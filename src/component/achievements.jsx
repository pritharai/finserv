...
const AchievementsSection = () => {
  ...
  return (
    <section className="relative bg-white-500 pt-16 pb-36 px-6">
      ...
      <div
        ref={counterRef}
        className="absolute bottom-[10px] left-1/2 transform -translate-x-1/2 w-[90%] md:w-[70%] bg-gradient-to-r from-blue-500 to-green-500 text-white rounded-xl shadow-xl py-5 px-6 grid grid-cols-2 md:grid-cols-2 justify-between text-center z-20"
      >
        <div>
